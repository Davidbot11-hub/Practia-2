package com.practica.dos.base.dataStruct.services;
...
import com.practica.dos.base.Dao.Dao_models.DaoAlbum;
import com.practica.dos.base.Dao.Dao_models.DaoCancion;
import com.practica.dos.base.Dao.Dao_models.DaoGenero;
    ...
    public List<HashMap> listCancion(){
        ...
        if(!db.listAll().isEmpty()) {
            ...
            for(int i = 0; i < arreglo.length; i++) {
                ...
                aux.put("albun", new DaoAlbum().listAll().get(arreglo[i].getIdAlbum() -1).getNombre());
                aux.put("id_albun", new DaoAlbum().listAll().get(arreglo[i].getIdAlbum() -1).getId().toString());
